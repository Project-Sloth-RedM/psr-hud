...
local function loadSettings()
    PSRCore.Functions.Notify(Lang:t("notify.hud_settings_loaded"), "success")
...
local function HandleSetupResource()
    PSRCore.Functions.TriggerCallback('hud:server:getRank', function(isAdminOrGreater)
...
local function restartHud()
    ...
    PSRCore.Functions.Notify(Lang:t("notify.hud_restart"), "error")
    Wait(1500)
    ...
    Wait(500)
    PSRCore.Functions.Notify(Lang:t("notify.hud_start"), "success")
...
RegisterNetEvent("hud:client:resetStorage", function()
    ...
    PSRCore.Functions.TriggerCallback('hud:server:getMenu', function(menu) loadSettings(menu); SetResourceKvp('hudSettings', json.encode(menu)) end)
end)
...
RegisterNetEvent('hud:client:BuffEffect', function(data)
    ...
    elseif data.display ~= nil then
        ...
        print("psr-hud error: data invalid from client event call: hud:client:BuffEffect")
    end
end)
...
RegisterNetEvent('hud:client:EnhancementEffect', function(data)
    ...
    elseif data.display ~= nil then
        ...
        print("psr-hud error: data invalid from client event call: hud:client:EnhancementEffect")
    end
end)
